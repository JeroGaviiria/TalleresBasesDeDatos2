...
CALL taller15.guardar_libro(9781234567899, 'Prueba', 'Prueba', 1605);
...
CALL taller15.actualizar_libro(9781234567897, 'Nuevo Título', 'Nuevo Autor', 2023);
...
SELECT taller15.obtener_autor_libro_por_isbn(9780131103627);
...
SELECT taller15.obtener_autor_libro_por_titulo('Nuevo Títuo');
...
BEGIN
    ...
    FROM 
        taller15.libros l
    WHERE 
        (xpath('/libro/anio/text()', descripcion))[1]::text = anio::text; -- Convertir el año a texto para la comparación
END;
$$ LANGUAGE plpgsql;

SELECT * FROM taller15.obtener_libros_por_anio(1605);
