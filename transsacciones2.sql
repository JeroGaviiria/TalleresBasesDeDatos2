...
ALTER SEQUENCE transsacciones2.clientes_id_seq
	RESTART 1;

ALTER SEQUENCE transsacciones2.pedidos_id_pedido_seq
	RESTART 1;
...
ROLLBACK TO SAVEPOINT antes_de_rollback;
